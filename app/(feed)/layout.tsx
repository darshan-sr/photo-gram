...
<aside id="default-sidebar" className="hidden md:block top-0 left-0 fixed z-40 w-64 h-screen transition-transform -translate-x-full sm:translate-x-0" aria-label="Sidebar">
